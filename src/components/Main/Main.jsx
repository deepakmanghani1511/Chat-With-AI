        ...
        <div className='main-container'>
            ...
            ? <>
                ...
                <div className='cards'>
                    <div className='card' onClick={() => handleCardClick("Suggest Some Place To Visit In Kerala")}>
                        <p>Suggest beautfiul places to see an upcoming road trip</p>
            ...
            <div className='main-bottom'>
                ...
                <p className='bottom-info'>
                    <p className='bottom-info'>
                        AI chat may display inaccurate info, including about people, so double-check its responses. Your privacy and AI Chat Apps 
                    </p>
                </p>
            </div>
        </div>
